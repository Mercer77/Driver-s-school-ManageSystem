...
<title>My JSP 'showstud.jsp' starting page</title>
...
<%
	...
	List<Jxstudents> list = studentsDao.findAllStudents();
...
<body onload="showTime()">
	<div class="main-content">
		...
		<div class="show-content">
			...
			<h2 style="text-shadow:1px 1px 1px black; margin-right: 5%;">学员信息</h2>
