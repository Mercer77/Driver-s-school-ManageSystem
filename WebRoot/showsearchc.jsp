...
<title>My JSP 'showsearchc.jsp' starting page</title>
...
<%
	try {
		...
		List<Coaches> list = coachesDao.getSeacher(text);
...
<body onload="showTime()">
	<div class="main-content">
		...
		<div class="show-content">
			...
			<h2 style="text-shadow:1px 1px 1px black;margin-right: 5%;">教练信息查询</h2>
			<div>
				<a href="showstud.jsp"
					style="font-size:15px;color:red; text-shadow:1px 1px 1px black;float: left;margin-left: 100px;">返回</a>
				<form action="showsearchc.jsp" method="post"
